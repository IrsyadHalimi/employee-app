...
class EchelonController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        ->addColumn('action', function($row) {
            ...
            $editButton = '<a href="javascript:void(0)" title="Edit" data-bs-toggle="modal" data-bs-target="#echelonEditModal" data-echelon_id="'. $echelonId .'" data-echelon_name="'. $echelonName .'"  class="editButton mx-2"><i class="fa-solid fa-file-pen"></i></a>';
            $deleteButton = '<a href="javascript:void(0)" title="Hapus" class="text-danger" onClick="deleteEchelon(\'' . $row->id . '\')"><i class="fa-solid fa-trash"></i></a>';
